...
export default function FlipBook({ bookId, bookTitle, bookEmoji, bookColor, pages }: Props) {
  ...
  if (!page) return (
    <div className="text-center py-8 font-sans text-white/40 text-sm">
      No pages uploaded yet. Admin needs to add images.
    </div>
  );
    ...
    <div className="flex flex-col items-center w-full" style={{userSelect:"none",WebkitUserSelect:"none"}}>
      ...
      <div className="relative" style={{maxWidth:380,width:"100%"}}>
        ...
        <div className="absolute left-0 top-2 bottom-2 w-3 z-10 pointer-events-none rounded-l-2xl"
          style={{
            background:`linear-gradient(90deg,${bookColor}dd,${bookColor}88,${bookColor}22)`,
            boxShadow:`2px 0 10px rgba(0,0,0,0.5)`,
          }}/>

        {/* RIGHT: Page edges effect */}
        ...
        <div
          ...
          {/* Image — objectFit:cover since images are 9:16 → no cropping */}
          {page.imageUrl ? (
          ...
          {/* Text overlay (admin optional) — bottom gradient */}
          {page.caption && (
          ...
          {/* Page number badge */}
          <div className="absolute top-3 left-3 rounded-full px-2.5 py-1 font-sans font-black text-[11px] text-white pointer-events-none"
            style={{background:"rgba(0,0,0,0.55)",backdropFilter:"blur(6px)"}}>
            {cur+1}/{total}
          </div>

          {/* Book emoji badge */}
          <div className="absolute top-3 right-3 rounded-full px-2.5 py-1 font-sans font-black text-[10px] pointer-events-none"
          ...
          {/* Left tap hint */}
          {hasPrev && (
            <div className="absolute left-2 top-1/2 -translate-y-1/2 pointer-events-none" style={{opacity:0.35}}>
          ...
          {/* Right tap hint — shows lock when audio not done */}
          {hasNext && (
            <div className="absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none"
              style={{opacity:0.45,animation:shakeNext?"shake 0.4s ease":"none"}}>
      ...
      {hasAudio && (
        <div className="w-full mt-4 px-2" style={{maxWidth:380}}>
          <div className="rounded-2xl px-4 py-3"
            ...
            {!audioReady && (
              <p className="font-sans text-[10px] text-center mt-2" style={{color:`${bookColor}cc`}}>
